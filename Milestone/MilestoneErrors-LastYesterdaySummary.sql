...
WHERE  (DATEDIFF(DAY, LogService.Message.receivetime, GETDATE()) = 2) AND LogService.MessageText.idSeverity <> 3
GROUP BY LogService.Message.ID_MessageId, LogService.MessageText.Message
ORDER BY [Count] DESC